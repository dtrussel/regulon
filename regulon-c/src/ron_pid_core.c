...
static ron_float_t pid_normalise(ron_float_t x,
                                 ron_float_t x_min,
                                 ron_float_t x_max)
{
...
static ron_float_t pid_denormalise(ron_float_t x_norm,
                                   ron_float_t out_min,
                                   ron_float_t out_max)
{
...
static ron_float_t pid_sp_filter(ron_float_t r,
                                 ron_float_t r_prev,
                                 ron_float_t tau_sp,
                                 ron_float_t dt)
{
...
static ron_float_t pid_derivative(const ron_pid_config_t *cfg,
...
static ron_float_t pid_integral(const ron_pid_config_t *cfg,
                                const ron_pid_state_t  *state,
                                ron_float_t             e,
                                ron_float_t             dt)
{
    ...
    if (cfg->aw_mode == RON_AW_CLAMPING)
    {
        const bool saturated_low =
            state->u_sat_prev <= (cfg->u_min + RON_FLOAT_EPSILON);
        const bool saturated_high =
            state->u_sat_prev >= (cfg->u_max - RON_FLOAT_EPSILON);
...
static ron_float_t pid_rate_limit(ron_float_t   u_sat,
                                  ron_float_t   u_prev,
                                  ron_float_t   du_max,
                                  ron_float_t   dt,
                                  bool         *limited)
...
static ron_fault_t pid_fail_step(ron_pid_instance_t *inst,
                                 ron_fault_t         code,
                                 ron_float_t        *u_out,
                                 ron_status_t       *status)
{
...
static bool pid_manual_step(ron_pid_state_t *state,
                            ron_float_t     *u_out,
                            ron_status_t    *status)
{
    bool handled;
...
static void pid_prepare_inputs(const ron_pid_config_t *cfg,
...
static ron_fault_t pid_apply_output_limits(ron_pid_instance_t *inst,
                                           ron_float_t         dt,
                                           ron_float_t         i_term,
                                           ron_float_t         u_raw,
                                           ron_float_t        *u_final,
                                           ...
                                           ron_status_t       *status)
{
    ...
    else
    {
        ...
        *u_final = pid_rate_limit(u_sat, inst->state.u_sat_prev, cfg->du_max, dt, &rate_limited);
        ...
        if ((cfg->aw_mode != RON_AW_NONE)
            && ((*step_status & RON_STATUS_SATURATED) != 0U))
        {
...
static void pid_store_step(ron_pid_state_t *state,
                           ron_float_t      y_n,
                           ron_float_t      e,
                           ron_float_t      e_d,
                           ron_float_t      d_term,
                              ...
                              ron_status_t       *status)
{
    ...
    else
    {
        ...
        fault = pid_apply_output_limits(inst,
                                        dt,
                                        i_term,
                                        u_raw,
                                        &u_final,
