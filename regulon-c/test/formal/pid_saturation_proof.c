...
#define PID_SATURATION_SIGNAL_BOUND RON_FLOAT_C(1000.0)
#define PID_SATURATION_DT_MAX RON_FLOAT_C(1.0)
...
void pid_saturation_proof(void)
{
    ...
    __CPROVER_assume(dt <= PID_SATURATION_DT_MAX);
    __CPROVER_assume(r >= -PID_SATURATION_SIGNAL_BOUND);
    __CPROVER_assume(r <= PID_SATURATION_SIGNAL_BOUND);
    __CPROVER_assume(y >= -PID_SATURATION_SIGNAL_BOUND);
    __CPROVER_assume(y <= PID_SATURATION_SIGNAL_BOUND);
